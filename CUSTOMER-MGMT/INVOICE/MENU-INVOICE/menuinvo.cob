...
OCESQL*
OCESQL 01  SQ0001.
OCESQL     02  FILLER PIC X(130) VALUE "SELECT REIMBURSEMENT_COST * 3,"
OCESQL  &  " REIMBURSEMENT_COST * 3, REIMBURSEMENT_COST * 3 FROM CUSTO"
OCESQL  &  "MER_REIMBURSEMENT WHERE UUID_CUSTOMER = $1".
...
OCESQL*            :WS-TOTAL-REST,
OCESQL*            :DISPLAY-RESULT
...
OCESQL          BY VALUE 9
OCESQL          BY VALUE -2
OCESQL          BY REFERENCE WS-TOTAL-REST
OCESQL     END-CALL
OCESQL     CALL "OCESQLSetResultParams" USING
OCESQL          BY VALUE 1
OCESQL          BY VALUE 3
OCESQL          BY VALUE 0
OCESQL          BY REFERENCE DISPLAY-RESULT
OCESQL     END-CALL
