...
cobc -locesql -x -o run $SIGN_IN_FRONT $SIGN_IN_BACK $MANAGEMENT_CUSTOMER $CREATE_CUSTOMER_FRONT $CREATE_CUSTOMER_BACK $SEARCH_CUSTOMER_FRONT $SEARCH_CUSTOMER_BACK $MENU_CUSTOMER_FRONT $MENU_CUSTOMER_BACK $UPDATE_CUSTOMER_FRONT $UPDATE_CUSTOMER_BACK $MENU_CONTRACT $CLASSIC_CONTRACT $SPECIFIC_CONTRACT $READ_CONTRACT
