...
OCESQL  &  "BURSEMENT_CREATE_DATE, REIMBURSEMENT_DOCTOR, REIMBURSEMENT"
OCESQL  &  "_PARMEDICAL, REIMBURSEMENT_HOSPITAL, REIMBURSEMENT_SINGLE_"
OCESQL  &  "GLASSES, REIMBURSEMENT_PROGRESSIVE_GLASSES, REIMBURSEMENT_"
OCESQL  &  "MOLAR_CROWNS, REIMBURSEMENT_NON_MOLAR_CROWNS, REIMBU".
OCESQL     02  FILLER PIC X(071) VALUE "RSEMENT_DESCALINGS FROM CUSTOM"
OCESQL  &  "ER_REIMBURSEMENT WHERE UUID_CUSTOMER = $1".
OCESQL     02  FILLER PIC X(1) VALUE X"00".
OCESQL*
       LINKAGE SECTION.
       01  LK-CUSTOMER.
